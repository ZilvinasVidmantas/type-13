...
console.group('----  Loginiai operatoriai ----');
{
  ...
  console.group('---- Lygybės ir nelygybės');
  {
    ...
    console.log(`${uzvakarTemp} > ${vakarTemp}`, uzvakarTemp > vakarTemp); // Daugiau
    console.log(`${uzvakarTemp} >= ${vakarTemp}`, uzvakarTemp >= vakarTemp); // Daugiau arba lygu
    console.log(`${uzvakarTemp} < ${vakarTemp}`, uzvakarTemp < vakarTemp); // Mažiau
    console.log(`${uzvakarTemp} <= ${vakarTemp}`, uzvakarTemp <= vakarTemp); // Mažiau arba lygu
    console.log(`${uzvakarTemp} == ${vakarTemp}`, uzvakarTemp == vakarTemp); // Atlaidi lygybė, gali nesutapti duomenų tipas, bet turi sutapt reikšmė
    console.log(`${uzvakarTemp} === ${vakarTemp}`, uzvakarTemp === vakarTemp); // Griežta lygybė, privalo sutapti ir duomenų tipas ir reikšmė.
